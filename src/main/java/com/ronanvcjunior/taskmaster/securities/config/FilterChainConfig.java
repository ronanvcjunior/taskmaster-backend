...
import com.ronanvcjunior.taskmaster.handlers.ApiAccessDeniedHandler;
import com.ronanvcjunior.taskmaster.handlers.ApiAuthenticationEntryPoint;
...
public class FilterChainConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .with(apiHttpConfig, withDefaults());
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(List.of(HTTP_DOMAINS));
